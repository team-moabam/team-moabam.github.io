...
<div id="content">
<div class="sect1">
<h2 id="_알림notification">알림(Notification)</h2>
<div class="sectionbody">
<div class="literalblock">
<div class="content">
<pre>콕 찌르기 알림, FCM Token 저장 기능을 제공합니다.</pre>
</div>
</div>
<div class="sect2">
<h3 id="_콕_찌르기_알림">콕 찌르기 알림</h3>
<div class="literalblock">
<div class="content">
<pre>1) 특정 방의 사용자가 다른 사용자를 콕 찌릅니다.
2) 서버에서 콕 찌를 대상의 FCM Token 여부를 검증합니다.
3) Firebase 서버에 FCM Push Messaing 알림을 비동기로 요청합니다.
4) Firebase 서버에서 FCM Token으로 식별된 기기에 알림을 보냅니다.</pre>
</div>
</div>
...
<div class="sect2">
<h3 id="_fcm_token_저장">FCM TOKEN 저장</h3>
<div class="literalblock">
<div class="content">
<pre>1) 특정 사용자의 FCM-TOKEN을 받아서 REDIS DB에 저장합니다.</pre>
</div>
</div>
<h4 id="_요청_2" class="discrete">요청</h4>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-http" data-lang="http">POST /notifications HTTP/1.1
Content-Type: application/x-www-form-urlencoded
Host: localhost:8080
Content-Length: 18

fcmToken=FCM-TOKEN</code></pre>
</div>
</div>
